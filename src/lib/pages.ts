...
export const generatePages: PageInfo[] = [
  {
    ...
    keywords: ['mock', 'dummy', 'test data', 'random', 'name', 'email', 'address', 'phone', 'company', 'lorem ipsum'],
  ...
  },
  {
    ...
    keywords: ['placeholder', 'color', 'gradient', 'pattern', 'avatar', 'thumbnail', 'background', 'svg'],
...
export const stringPages: PageInfo[] = [
  {
    ...
    keywords: ['diff', 'difference', 'compare', 'merge', 'text', 'changes', 'git diff', 'side by side'],
...
export const inspectPages: PageInfo[] = [
  {
    ...
    keywords: ['keyboard', 'key', 'keycode', 'event', 'modifier', 'ctrl', 'alt', 'shift', 'meta', 'keydown', 'keyup'],
