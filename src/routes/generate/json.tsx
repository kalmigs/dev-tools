      ...
      <ControlGroup title="Structure" defaultOpen={true}>
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1.5">
            <LabelWithTooltip
              label="Keys"
              tooltip="Number of top-level properties in the generated JSON object"
            />
            <NumberInput
          ...
          <div className="flex flex-col gap-1.5">
            <LabelWithTooltip
              label="Max Depth"
              tooltip="Maximum nesting level for objects and arrays. 0 = flat, no nesting"
            />
            <NumberInput
        ...
        <ControlGroup title="Arrays" defaultOpen={false}>
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              <LabelWithTooltip
                label="Min Length"
                tooltip="Minimum number of elements in generated arrays"
              />
              <NumberInput
            ...
            <div className="flex flex-col gap-1.5">
              <LabelWithTooltip
                label="Max Length"
                tooltip="Maximum number of elements in generated arrays"
              />
              <NumberInput
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <LabelWithTooltip
                  label="Number Min"
                  tooltip="Minimum value for generated numbers"
                />
                <NumberInput
              ...
              <div className="flex flex-col gap-1.5">
                <LabelWithTooltip
                  label="Number Max"
                  tooltip="Maximum value for generated numbers"
                />
                <NumberInput
        ...
        <div className="flex flex-col gap-3">
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              <LabelWithTooltip
                label="Count"
                tooltip="Generate multiple JSON objects as an array"
              />
              <NumberInput
                value={config.count}
          ...
          {advancedMode && (
            <div className="flex flex-col gap-1.5">
              <LabelWithTooltip
                label="Seed"
                tooltip="Enter any text to generate reproducible output. Same seed = same JSON"
              />
              <input
                type="text"
                value={config.seed}
    ...
    return generatedJson.split('\n').map((line, lineIndex) => {
      ...
      while ((match = regex.exec(remaining)) !== null) {
        ...
        if (match.index > lastIndex) {
          parts.push(
            <span key={`ws-${lineIndex}-${keyIndex++}`}>
